...
<?php endif; ?>
    ...
    <section class="container -align-center mt-5">
        <img src="<?php echo e(asset('images/admission/0.jpg')); ?> " width="" height="" alt="">
        <img src="<?php echo e(asset('images/admission/208.jpg')); ?> " width="" height="" alt="">
        <img src="<?php echo e(asset('images/admission/274.jpg')); ?> " width="" height="" alt="">
        <img src="<?php echo e(asset('images/admission/133-1.jpg')); ?> " width="" height="" alt="">
        <img src="<?php echo e(asset('images/admission/133.jpg')); ?> " width="" height="" alt="">
        <img src="<?php echo e(asset('images/admission/192.jpg')); ?> " width="" height="" alt="">
        <img src="<?php echo e(asset('images/admission/191.jpg')); ?> " width="" height="" alt="">
    </section>
...
<?php endif; ?>
<?php /**PATH Z:\Laragon-Server\www\laravel-11\resources\views/agromaster/admission/index.blade.php ENDPATH**/ ?>